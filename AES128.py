...
#preliminaries()
message = [[["3F", "EE", "C0", "E3"], ["93", "29", "87", "A8"], ["F7", "78", "65", "87"], ["D4", "AE", "0B", "EF"]]] #Delete after test!   ORIGINALLY USED "hello"
key = [["42", "69", "54", "21"], ["F5", "79", "C9", "FE"], ["8D", "65", "52", "41"], ["96", "9F", "75", "05"]] #Delete after test!       ORIGINALLY USED "0123456789ABCDEF0123456789ABCDEF"

for i in range(len(message[0])):
    for j in range(len(message[0][i])):
        message[0][i][j] = int(message[0][i][j], 16)
